...
export default function LikedSongScreen() {
    ...
    try {
      ...
      TrackPlayer.updateOptions({
        ...
        capabilities: [
          ...
          TrackPlayer.CAPABILITY_PAUSE, // Oynatıcı'da duraklatma işlemi için kullanırız.
          TrackPlayer.CAPABILITY_STOP, // Oynatıcıda Durdurma işlemi için kullanırız.
          TrackPlayer.CAPABILITY_SKIP_TO_NEXT, // Oynatıcıda bir sonraki müziğ'e geçiş yapabilmesi için kullanılır.
          TrackPlayer.CAPABILITY_SKIP_TO_PREVIOUS, // Oynatıcıda bir önceki müziğ'e geçiş yapabilmesi için kullanılır.
  ...
  const handlePlay = async track => {
    const trackData = {
      id: track.track.key,
      url: track.track.hub.actions.find(action => action.type === 'uri').uri, // Ses dosyasının URL'i
  ...
  return (
    <>
      ...
      <Modal
        ...
        swipeDirection="down" // Modal'ın hangi yöne kaydırılacağını belirler.
